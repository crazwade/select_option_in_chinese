# select-option-in-chinese
 <select>
    ...
    <option value="尼加拉瓜共和國">尼加拉瓜共和國</option>
    <option value="多明尼加共和國">多明尼加共和國</option>
    <option value="聖文森國">聖文森國</option>
    ...
    <option value="巴布亞紐幾內亞獨立國">巴布亞紐幾內亞獨立國</option>
    <option value="斐濟共和國">斐濟共和國</option>
    <option value="諾魯共和國">諾魯共和國</option>
    <option value="巴林王國">巴林王國</option>
    <option value="科威特">科威特</option>
    <option value="約旦哈希米王國">約旦哈希米王國</option>
    <option value="瓜地馬拉共和國">瓜地馬拉共和國</option>
    <option value="哥倫比亞共和國">哥倫比亞共和國</option>
    <option value="歐洲聯盟">歐洲聯盟</option>
    <option value="巴基斯坦">巴基斯坦</option>
    <option value="不丹">不丹</option>
    <option value="梵蒂岡">梵蒂岡</option>
    <option value="聖馬利諾">聖馬利諾</option>
    <option value="列支敦斯登">列支敦斯登</option>
    <option value="南賽普勒斯">南賽普勒斯</option>
    <option value="波士尼亞">波士尼亞</option>
    ...
    <option value="摩達維亞">摩達維亞</option>
    <option value="喬治亞">喬治亞</option>
    <option value="馬紹爾共和國">馬紹爾共和國</option>
